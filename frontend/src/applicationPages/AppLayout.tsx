  ...
  return (
    <div className="flex flex-col h-screen bg-[SIDEBAR_BG] " style={{ backgroundColor: SIDEBAR_BG }}>
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        <div className="flex-1 min-h-0 min-w-0 px-1 py-1 flex overflow-hidden">
          <main
            className="flex-1 min-w-0 h-full min-h-0 overflow-auto rounded-lg scroll-smooth scrollbar-app"
