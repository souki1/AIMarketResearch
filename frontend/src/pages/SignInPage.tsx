      ...
      <div className="w-full max-w-sm mx-auto">
        ...
        >
          ...
          <div className="mt-6 flex flex-col gap-3">
            <button
              type="button"
              className="w-full flex items-center justify-center gap-2.5 rounded-lg border border-white/20 bg-transparent px-3 py-2 text-sm text-white hover:bg-white/10 transition-colors font-medium cursor-pointer"
            >
